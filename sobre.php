        ...
        <div class="sidebar">
              ...
              <div class="col-md-4">
                <div class="p-4 shadow-sm rounded bg-white h-100">
                  <h3 class="h5 fw-bold text-warning mb-3">
                    <i class="bi bi-leaf me-2"></i>Sustentabilidade
                  </h3>
                  <p class="text-secondary mb-0">
                    Buscamos impactar positivamente o mundo com práticas responsáveis, usando materiais e processos que respeitam o meio ambiente.
                  </p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="p-4 shadow-sm rounded bg-white h-100">
                  <h3 class="h5 fw-bold text-warning mb-3">
                    <i class="bi bi-people me-2"></i>Atendimento Único
                  </h3>
                  <p class="text-secondary mb-0">
                    Cada cliente é especial. Oferecemos um atendimento personalizado para que cada peça seja parte da sua história.
                  </p>
                </div>
              </div>
              <div class="col-md-4">
                <div class="p-4 shadow-sm rounded bg-white h-100">
                  <h3 class="h5 fw-bold text-warning mb-3">
                    <i class="bi bi-lightning me-2"></i>Moda com Atitude
                  </h3>
                  <p class="text-secondary mb-0">
                    Criatividade, inclusão e estilo em coleções que refletem liberdade, autenticidade e confiança.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-lg-8 text-center">
                <p class="fw-medium text-dark fs-5 mb-4">
                  Mais que uma loja, somos uma comunidade.<br>
                  Descubra um universo onde estilo ganha voz e atitude.
                </p>
                <a href="/colecao" class="btn btn-dark btn-lg rounded-pill px-4">
                  Explore a coleção
                </a>
              </div>
            </div>
          ...
          <div class="container my-5">
            <div class="row g-4 justify-content-center">
              ...
              <div class="col-md-6 text-center">
                <h2 class="mb-3" 
                    style="color: #ffffff; background: rgb(0, 0, 0); 
                           border-radius: 10px; padding: 6px 20px; display: inline-block;">
                  Loja 1 (masculina)
                </h2>
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3659.3027172274296!2d-46.38349142398743!3d-23.485603558814674!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce63426bf6a443%3A0x74541d8e80b6b607!2sAvenida%20Marechal%20Tito%2C%207579%20-%20Jardim%20das%20Oliveiras%2C%20S%C3%A3o%20Paulo%20-%20SP%2C%2008115-100!5e0!3m2!1spt-BR!2sbr!4v1755602349685!5m2!1spt-BR!2sbr" 
                    class="w-100"
                    height="300"
                    style="border:0; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.2);"
              ...
              <div class="col-md-6 text-center">
                ...
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3659.351021759512!2d-46.3533518239874!3d-23.483862858751053!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce7ca66154c8ab%3A0x1fee5dd8b0c3cd59!2sAv.%20Italo%20Adami%2C%20379%20-%20Vila%20Zeferina%2C%20Itaquaquecetuba%20-%20SP%2C%2008574-020!5e0!3m2!1spt-BR!2sbr!4v1755602276429!5m2!1spt-BR!2sbr"
                    class="w-100"
                    height="300"
                    style="border:0; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.2);"
                    allowfullscreen="" loading="lazy">
