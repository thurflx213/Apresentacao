<div class="page-wrapper">
    ...
    <div class="form-card card-confirmacao">
        ...
        <h3 class="item-to-delete">Categoria: <?= htmlspecialchars($categoria['nome_categorias']); ?></h3>
        <p class="warning-message">Esta ação não pode ser desfeita facilmente. Todos os produtos vinculados a esta categoria podem ser afetados.</p>

        <hr>
        <form action="/backend/categoria/deletar/<?= $categoria['id_categorias']; ?>" method="POST">
