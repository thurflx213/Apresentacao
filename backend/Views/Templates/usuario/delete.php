...
<div class="page-wrapper">
    ...
    <div class="form-card card-confirmacao">
        ...
        <p>Você tem certeza que deseja inativar (excluir) este usuário?</p>

        <h3 class="user-to-delete">Usuário: <?= htmlspecialchars($usuario['nome_usuarios']); ?></h3>

        <p class="warning-message">Esta ação não pode ser desfeita facilmente e o usuário deixará de aparecer no site público.</p>

        <hr> <form action="/backend/usuario/deletar" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="id_usuarios" value="<?= $usuario['id_usuarios']; ?>">

            <div class="button-group">
                <button type="submit" class="btn-confirm-delete">
                    <i class="fa fa-trash"></i> Sim, Inativar Usuário
                </button>
