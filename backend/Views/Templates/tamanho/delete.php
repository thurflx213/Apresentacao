<div class="page-wrapper">
    ...
    <div class="form-card card-confirmacao">
        <p>Você tem certeza que deseja excluir este tamanho?</p>
        <h3 class="item-to-delete">Tamanho: <?= htmlspecialchars($tamanho['tamanho_tamanhos']); ?> (Produto #<?= $tamanho['id_produto']; ?>)</h3>
        <p class="warning-message">Esta ação não pode ser desfeita. O estoque vinculado a este tamanho será removido.</p>

        <hr>
        <form action="/backend/tamanho/deletar/<?= $tamanho['id_tamanhos']; ?>" method="POST">
