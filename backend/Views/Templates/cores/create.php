<div class="page-wrapper">
    <h3 class="page-title"><i class="fa fa-plus-circle" style="color: #f2cc7d;"></i> Nova Cor</h3>
    
    <header class="header-breadcrumb">
        <h5><b><i class="fa fa-palette"></i> Cadastrar variação de cor para produto - Koketsu</b></h5>
    </header>

    <form action="/backend/cor/salvar" method="post" class="form-card">
        ...
        <div class="form-group">
            <label><i class="fa fa-palette"></i> Cor:</label>
            <input type="text" name="cor_cores" placeholder="Ex: Vermelho, Azul Marinho..." required>
        </div>

        <div class="form-group">
            <label><i class="fa fa-cubes"></i> Quantidade em Estoque:</label>
            <input type="number" name="quantidade_cores" placeholder="Ex: 50" required min="0">
        </div>

        <div class="actions-container">
            <button type="submit" class="btn-save">
                <i class="fa fa-save"></i> Salvar Cor
            </button>
