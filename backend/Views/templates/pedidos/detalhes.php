<?php 
// Esta View recebe um único pedido na variável $pedido, que é um array associativo.
// Se o pedido não for encontrado, exibe uma mensagem de erro.
if (empty($pedido)): ?>
...
<?php else: 
    // Se o pedido for encontrado, exibimos os detalhes.
?>
...
<div class="w3-container w3-margin-bottom" style="max-width: 800px;">
    ...
    <div class="w3-card-4 w3-white w3-padding">
        <div class="w3-row-padding">
            ...
            <div class="w3-half">
                <p><strong>ID:</strong> <?= htmlspecialchars($pedido['id_pedido']) ?></p>
                ...
                <p><strong>Criado em:</strong> <?= htmlspecialchars($pedido['criado_em']) ?></p>
            </div>

            <!-- Coluna da Imagem (Exemplo) -->
            <div class="w3-half w3-center">
                <!-- Se você tiver o link da imagem no campo 'imagem_pedidos', use-o aqui. Caso contrário, este é um placeholder. -->
                <img src="https://placehold.co/250x250/007bff/white?text=pedido+<?= htmlspecialchars($pedido['id_pedido']) ?>" 
