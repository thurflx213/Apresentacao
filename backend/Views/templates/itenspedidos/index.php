...
<th>Ações</th> <!-- Adicionada coluna Ações para os botões -->
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td><?= htmlspecialchars($itempedido['preco_unitario']) ?></td>
      <td style="display:flex; gap: 5px;">
        <a class="w3-button w3-round w3-blue w3-hover-red w3-padding-small"
         href="/backend/itenspedidos/editar/<?= htmlspecialchars($itempedido['id_itens_pedidos']) ?>">Editar</a>
     
        <a class="w3-button w3-round w3-red w3-hover-dark-grey w3-padding-small"
         href="/backend/itenspedidos/deletar/<?= htmlspecialchars($itempedido['id_itens_pedidos']) ?>">Excluir</a>
      </td>
    </tr>
    <?php endforeach; ?>
  </tbody>
