        ...
        <section class="produtos" style="padding: 40px 0;">
            <div class="container">
                ...
                <div id="produtos-lista" class="produtos-grid">
                    <?php
                    // Debug temporário
                    error_log("DEBUG: \$produtos = " . json_encode($produtos));
                    error_log("DEBUG: count(\$produtos) = " . count($produtos));
                    ...
                    if (isset($produtos) && is_array($produtos) && count($produtos) > 0):
                        foreach ($produtos as $produto): 
                            ...
                            $imagem = htmlspecialchars($produto['imagem_produtos'] ?? 'default.png');
                    ...
                    <div class="produto-card" data-category="<?= $categoria ?>">
                        <div class="produto-card__image-container">
                            ...
                            <?php endif; ?>
                            <img src="/backend/upload/produtos/<?= htmlspecialchars($imagem); ?>" 
                                 alt="<?= $nome; ?>" 
