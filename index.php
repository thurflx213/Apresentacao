  ...
  <header>
    ...
    <nav id="navbar" class="navbar d-flex align-items-center px-4 sticky-top">
      ...
      <div class="navbar-end d-flex justify-content-end align-items-center">
        <a href="/backend/login" class="icon-link"><i class="bi bi-person"></i> Login</a>
  ...
  <div >
    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          ...
          <div class="carousel-item" data-bs0interval="500">
  ...
  <footer>
    <div class="container">
        <div class="coluna-footer">
            ...
            <form action="" method="POST" enctype="text/plain" class="form-email">
