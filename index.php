...
<body>
  <header>
    ...
    <nav id="navbar" class="navbar d-flex align-items-center px-4 sticky-top">
      ...
      <div class="navbar-section d-flex align-items-center" style="margin-left: 70px;">
      ...
      <!-- Centro: Logo -->
        <img src="img/logo.png" alt="Logo COMP" class="logo"/>
      </div>
    ...
    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active" data-bs-interval="1000">
            <img src="img/COMP1.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item" data-bs-interval="1000">
            <img src="img/COMP2.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item" data-bs0interval="1000">
            <img src="img/COMP3.png" class="d-block w-100" alt="...">
          </div>
        </div>
  ...
  <footer>
    <div class="container">
        ...
        <div class="coluna-footer">
          ...
          <a href="#"><p>Programa de Fidelidade</p></a>
